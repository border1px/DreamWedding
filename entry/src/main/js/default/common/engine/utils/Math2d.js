...
export class QuadraticBezierEnumerator {
    ...
    get current() {
        ...
        ret.x =
            this._startAnchorPoint.x * ret.x + this._controlPoint0.x * ret.y + this._endAnchorPoint.x;
        ret.y =
            this._startAnchorPoint.y * ret.x + this._controlPoint0.y * ret.y + this._endAnchorPoint.y;
        return ret;
    }
    moveNext() {
        this._currentIdx++;
